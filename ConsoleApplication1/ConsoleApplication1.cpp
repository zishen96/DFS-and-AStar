...
int main()
{
    ...
    while (dfsDone != true)
    {
        ...
        else
        {
            ...
            if (leftBound >= 0 && grid[currX][leftBound] != "##" && !leftPath)
            {
            ...
            if (upBound >= 0 && grid[upBound][currY] != "##" && !upPath)
            {
            ...
            if (rightBound < col && grid[currX][rightBound] != "##" && !rightPath)
            {
            ...
            if (downBound < row && grid[downBound][currY] != "##" && !downPath)
            {
